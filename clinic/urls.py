...
#* update 25-12
    ...
    path('api/test_export/', TestExportExcel.as_view()),
    path('api/test_dich_vu_export/', TestExportExcelDichVu.as_view()),
    path('api/test_thuoc_export/', TestExportExcelThuoc.as_view()),
