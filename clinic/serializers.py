...
class ChildUserSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        # fields = '__all__'
        fields = ('id', 'so_dien_thoai', 'ho_ten',
                  'email', 'cmnd_cccd', 'chuc_nang')
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        # fields = '__all__'
        fields = ('id', 'so_dien_thoai', 'ho_ten', 'email', 'cmnd_cccd', 'dia_chi', 'ngay_sinh',
                  'gioi_tinh', 'ma_benh_nhan', 'dan_toc', 'anh_dai_dien', 'ma_so_bao_hiem')
...
class DangKiSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('so_dien_thoai', 'password',
                  'ho_ten', 'cmnd_cccd', 'dia_chi')
        extra_kwargs = {
...
class DichVuKhamSerializerSimple(serializers.ModelSerializer):
    class Meta:
        model = DichVuKham
        fields = ('id', 'ma_dvkt', 'ten_dvkt', 'ma_gia',
                  'quyet_dinh', 'cong_bo', 'ma_cosokcb')
...
class PhongChucNangSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        phong_chuc_nang = PhongChucNang.objects.get_or_create(
            ten_phong_chuc_nang=ten_phong_chuc_nang)[0]
        return phong_chuc_nang

    def to_representation(self, instance):

        response = super().to_representation(instance)
        response['dich_vu_kham'] = DichVuKhamSerializer(
            instance.dich_vu_kham).data
        return response
...
class ChuoiKhamSerializerSimple(serializers.ModelSerializer):
    ...
    hoan_thanh_kham = serializers.CharField(
        source='lich_hen.check_hoan_thanh_kham')

    class Meta:
        model = ChuoiKham
        fields = ('id', 'thoi_gian_bat_dau', 'thoi_gian_ket_thuc',
                  'benh_nhan', 'bac_si_dam_nhan', 'trang_thai', 'hoan_thanh_kham')
...
class ChuoiKhamPhanKhoaSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ChuoiKham
        fields = ('id', 'thoi_gian_bat_dau', 'thoi_gian_ket_thuc',
                  'benh_nhan', 'bac_si_dam_nhan', 'trang_thai')
...
class KetQuaChuyenKhoaSerializer(serializers.ModelSerializer):
    file_chuyen_khoa = FileKetQuaChuyenKhoaSerializer(
        many=True, source='file_ket_qua_chuyen_khoa')
...
class KetQuaTongQuatSerializer(serializers.ModelSerializer):
    file_tong_quat = FileKetQuaTongQuatSerializer(
        source='file_ket_qua_tong_quat', many=True)
    kq_chuyen_khoa = KetQuaChuyenKhoaSerializer(
        source='ket_qua_chuyen_khoa', many=True)

    class Meta:
        model = KetQuaTongQuat
        fields = ('id', 'ma_ket_qua', 'mo_ta', 'ket_luan',
                  'file_tong_quat', 'kq_chuyen_khoa')
...
class PhanKhoaKhamDichVuSerializer(serializers.ModelSerializer):
    class Meta:
        model = PhanKhoaKham
        fields = ('id', 'chuoi_kham', 'benh_nhan', 'bac_si_lam_sang',
                  'thoi_gian_bat_dau', 'thoi_gian_ket_thuc', 'dich_vu_kham')
...
class ChuoiKhamUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ChuoiKham
        fields = ('id', 'bac_si_dam_nhan',
                  'thoi_gian_bat_dau', 'thoi_gian_ket_thuc')


class LichHenKhamUserSerializer(serializers.ModelSerializer):
    trang_thai = TrangThaiLichHenSerializer()
    chuoi_kham = ChuoiKhamUserSerializer(
        source='danh_sach_chuoi_kham', many=True)

    class Meta:
        model = LichHenKham
        fields = ('id', 'thoi_gian_bat_dau', 'thoi_gian_ket_thuc',
                  'trang_thai', 'chuoi_kham')
...
class LichHenKhamSerializerSimple(serializers.ModelSerializer):
    ...
    class Meta:
        model = LichHenKham
        fields = ('id', 'thoi_gian_bat_dau',
                  'thoi_gian_ket_thuc', 'trang_thai')
...
class BaiDangSerializer(serializers.ModelSerializer):
    noi_dung_chinh = serializers.CharField(
        source='get_truncated_noi_dung_chinh')
...
class UserUpdateInfoSerializer(serializers.ModelSerializer):
    class Meta:
        model = User
        fields = ('id', 'ho_ten', 'so_dien_thoai', 'email', 'cmnd_cccd',
                  'ngay_sinh', 'gioi_tinh', 'dia_chi', 'dan_toc', 'ma_so_bao_hiem')
...
class TatCaLichHenSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = LichHenKham
        fields = ('id', 'ma_lich_hen', 'thoi_gian_bat_dau',
                  'thoi_gian_ket_thuc', 'trang_thai')
...
class FilterHoaDonChuoiKhamBaoHiemSerializer(serializers.ModelSerializer):
    ...
    ma_bhyt = serializers.CharField(
        source='chuoi_kham.benh_nhan.ma_so_bao_hiem')
...
class ChiTietChiSoXetNghiemSerializer(serializers.ModelSerializer):
    chi_so_binh_thuong_min = serializers.CharField(
        source='get_chi_so_binh_thuong_min')
    chi_so_binh_thuong_max = serializers.CharField(
        source='get_chi_so_binh_thuong_max')
