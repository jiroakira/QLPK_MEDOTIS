...
(function (d) {
                    ...
                    for (var g = 0, f = e.length; g < f; g++) {
                        ...
                        if (h.key)
                            if (h.key === a) (b._buttonsHandled = !0), d(l).click();
                                ...
                                if (!h.key.altKey || b.altKey) if (!h.key.ctrlKey || b.ctrlKey) if (!h.key.metaKey || b.metaKey) (b._buttonsHandled = !0), d(l).click();
    ...
    i.Api.register("buttons().containers()", function () {
        ...
        this.iterator(!0, "table", function (c) {
            if (c._buttons) for (var c = n.instanceSelector(b, c._buttons), d = 0, g = c.length; d < g; d++) a = a.add(c[d].container());
        });
        return a;
    });
