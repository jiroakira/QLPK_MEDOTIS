        ...
        (r.prototype.init = function () {
            ...
            this.respChart(
                ...
                "Line",
                {
                    ...
                    datasets: [
                        { backgroundColor: "rgba(220,220,220, 0.75)", borderColor: "rgba(220,220,220, 0.75)", pointColor: "rgba(220,220,220,1)", pointStrokeColor: "#fff", data: [33, 52, 63, 92, 50, 53, 46] },
                        { backgroundColor: "rgba(59,192,195,0.4)", borderColor: "rgba(59,192,195,0.4)", pointColor: "rgba(59,192,195,1)", pointStrokeColor: "#fff", data: [22, 20, 30, 60, 29, 25, 12] },
                        { backgroundColor: "rgba(97, 92, 168, 0.4)", borderColor: "rgba(97, 92, 168, 0.4)", pointColor: "rgba(97, 92, 168, 0.4)", pointStrokeColor: "#fff", data: [14, 16, 12, 5, 32, 9, 33] },
                    ],
                },
                r
            );
            this.respChart(d("#doughnut"), "Doughnut", { datasets: [{ data: [30, 50, 100, 40, 120], backgroundColor: ["#E67A77", "#D9DD81", "#79D1CF", "#95D7BB", "#4D5360"] }] });
            this.respChart(d("#pie"), "Pie", { datasets: [{ data: [40, 80, 70], backgroundColor: ["#dcdcdc", "#3bc0c3", "#1a2942"] }] });
            r = { legend: { display: !1 } };
            this.respChart(
                d("#bar"),
                "Bar",
                {
                    labels: ["January", "February", "March", "April", "May", "June", "July"],
                    datasets: [
                        { backgroundColor: "#1a2942", borderColor: "#1a2942", data: [65, 59, 90, 81, 56, 55, 40] },
            ...
            this.respChart(d("#polarArea"), "PolarArea", {
                datasets: [{ data: [30, 90, 24, 58, 82, 8], backgroundColor: ["#ebc142", "#3bc0c3", "#1a2942", "#f13c6e", "#615ca8", "#1ca8dd"] }],
