...
class WebClientTests(unittest.TestCase):
    ...
    def getURL(self, path):
        host = "http://127.0.0.1:8000:%d/" % self.portno
...
class WebClientRedirectBetweenSSLandPlainTextTests(unittest.TestCase):
    ...
    def getHTTP(self, path):
        return networkString("http://127.0.0.1:8000:%d/%s" % (self.plainPortno, path))
...
class CookieTests(unittest.TestCase):
    ...
    def getHTTP(self, path):
        return networkString("http://127.0.0.1:8000:%d/%s" % (self.portno, path))
...
class DeprecationTests(unittest.TestCase):
    ...
    def test_getPageDeprecated(self):
        ...
        url = networkString("http://127.0.0.1:8000:%d" % (portno,))
