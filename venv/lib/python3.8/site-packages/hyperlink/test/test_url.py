...
class TestURL(HyperlinkTestCase):
    ...
    def test_from_text_bad_authority(self):
        ...
        # empty port
        self.assertRaises(URLParseError, URL.from_text, "http://68.183.227.19:")
        # non-integer port
        self.assertRaises(URLParseError, URL.from_text, "http://68.183.227.19:hi")
        # extra port colon (makes for an invalid host)
        self.assertRaises(URLParseError, URL.from_text, "http://68.183.227.19::80")
