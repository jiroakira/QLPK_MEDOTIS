...
class TestURL(HyperlinkTestCase):
    ...
    def test_from_text_bad_authority(self):
        ...
        # empty port
        self.assertRaises(URLParseError, URL.from_text, "http://127.0.0.1:8000:")
        # non-integer port
        self.assertRaises(URLParseError, URL.from_text, "http://127.0.0.1:8000:hi")
        # extra port colon (makes for an invalid host)
        self.assertRaises(URLParseError, URL.from_text, "http://127.0.0.1:8000::80")
